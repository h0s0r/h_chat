...
search_tool = TavilySearchResults( # selecting search tool Tavily and setting k to 13 which is the number of top relevant results that will be provided
    k=13
)

tools = [search_tool] # tools is a list that will hold all the tools that our agent is allowed to use
